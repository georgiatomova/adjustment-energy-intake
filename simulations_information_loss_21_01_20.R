...
CompVar <- lapply(SimDatasets, function(y) {
  ...
  y$RemainingEnergy <- y$CRB + y$FBR + y$UF + y$PRO + y$SF + y$ALC;
  return(y)
})
...
wi.i <- c(mean(SimData.i$CRB)/mean(SimData.i$RemainingEnergy),
        mean(SimData.i$FBR)/mean(SimData.i$RemainingEnergy),
        mean(SimData.i$UF)/mean(SimData.i$RemainingEnergy),
        mean(SimData.i$PRO)/mean(SimData.i$RemainingEnergy),
        mean(SimData.i$SF)/mean(SimData.i$RemainingEnergy),
        mean(SimData.i$ALC)/mean(SimData.i$RemainingEnergy))
...
mod_total_partition   <- lm(WT ~ NMES + RemainingEnergy, data=SimData)
mod_total_partition.i <- lm(WT ~ NMES + RemainingEnergy, data=SimData.i)
